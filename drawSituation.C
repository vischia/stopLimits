void drawSituation(TString who, TString card, TString location, TString theLabel, TString signalLabel)
{
  ...
  systList.push_back("ttbar_ElMu_statbin8");
  systList.push_back("ttbar_ElMu_statbin9");
  systList.push_back("ttbar_ElMu_statbin10");
  systList.push_back("ttbar_ElMu_statbin11");
  systList.push_back("ttbar_ElMu_statbin12");
  systList.push_back("ttbar_ElMu_statbin13");
  systList.push_back("ttbar_ElMu_statbin14");
  systList.push_back("ttbar_ElMu_statbin15");
  systList.push_back("ttbar_ElMu_statbin16");
  systList.push_back("ttbar_ElMu_statbin17");
  systList.push_back("ttbar_ElMu_statbin18");
  systList.push_back("ttbar_ElMu_statbin19");
  systList.push_back("ttbar_ElMu_statbin20");
  systList.push_back("ttbar_ElMu_statbin21");
  systList.push_back("ttbar_ElMu_statbin22");
  systList.push_back("ttbar_ElMu_statbin23");
  systList.push_back("ttbar_ElMu_statbin24");
  systList.push_back("ttbar_ElMu_statbin25");
  systList.push_back("ttbar_ElMu_statbin26");
  ...
  systList.push_back("SFS_250_50_ElMu_statbin8");
  systList.push_back("SFS_250_50_ElMu_statbin9");
  systList.push_back("SFS_250_50_ElMu_statbin10");
  systList.push_back("SFS_250_50_ElMu_statbin11");
  systList.push_back("SFS_250_50_ElMu_statbin12");
  systList.push_back("SFS_250_50_ElMu_statbin13");
  systList.push_back("SFS_250_50_ElMu_statbin14");
  systList.push_back("SFS_250_50_ElMu_statbin15");
  systList.push_back("SFS_250_50_ElMu_statbin16");
  systList.push_back("SFS_250_50_ElMu_statbin17");
  systList.push_back("SFS_250_50_ElMu_statbin18");
  systList.push_back("SFS_250_50_ElMu_statbin19");
  systList.push_back("SFS_250_50_ElMu_statbin20");
  systList.push_back("SFS_250_50_ElMu_statbin21");
  systList.push_back("SFS_250_50_ElMu_statbin22");
  systList.push_back("SFS_250_50_ElMu_statbin23");
  systList.push_back("SFS_250_50_ElMu_statbin24");
  systList.push_back("SFS_250_50_ElMu_statbin25");
  systList.push_back("SFS_250_50_ElMu_statbin26");

  systList.push_back("hdamp");
  systList.push_back("Scale");
  systList.push_back("ue");
  systList.push_back("isr");
  systList.push_back("fsr");
  systList.push_back("nlo");
  systList.push_back("had");
  systList.push_back("CR");
  systList.push_back("ME");
  systList.push_back("MET");
  systList.push_back("Trig");
  systList.push_back("JES");
  systList.push_back("Btag");
  systList.push_back("JER");
  systList.push_back("MisTag");
  systList.push_back("MuonEff");
  systList.push_back("ElecEff");
  systList.push_back("PU");
  systList.push_back("PDF");
  //systList.push_back("pdf");
  systList.push_back("topMass");
